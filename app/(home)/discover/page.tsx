...
export const metadata: Metadata = {
  title: 'Discover Community Videos | ReelVan',
  description:
    'Explore AI videos created and shared by the ReelVan community. Get inspired by real examples of watermark removal, quality enhancement, and AI-generated captions.',
  keywords: [
    'AI video examples',
    'Sora video showcase',
    'AI video gallery',
  ...
  openGraph: {
    title: 'Discover Community Videos | ReelVan',
    description:
      'Explore real AI videos created by our community. Get inspired for your next project.',
  },
}
        ...
        <div className="mx-auto max-w-2xl">
          <Card className="p-12 text-center">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              We're just getting started! Soon this page will showcase amazing videos created by our
              community. Be among the first to share your creations.
            </p>
