...
import type { Blog, CoreContent } from '@/types/content'
          ...
          <div className="relative max-w-lg">
            <label>
              ...
              <input
                ...
                className="focus:border-primary-500 focus:ring-primary-500 border-border bg-card text-foreground block w-full rounded-md border px-4 py-2"
              />
            </label>
            <svg
